...
variable "performance_insights_retention_period" {
  ...
  validation {
    condition     = contains([0, 7, 731], var.performance_insights_retention_period) || (var.performance_insights_retention_period % 31 == 0 && 31 <= var.performance_insights_retention_period && var.performance_insights_retention_period <= 713)
