...
module "webapp_lambda_to_pg_webapp_db_sg" {

  source                 = "./terraform/aws/vpc/security_group"

  name                   = "webapp-lambda-to-pg-webapp-db-sg"    # ✅ Optional argument, ❗ Forces new resource.
  description            = "WebApp Lambda to PG WebApp DB SG"    # ✅ Optional argument, ❗ Forces new resource.
  egress_rules           = [
    {
  ...
  ingress_rules          = [
    {
      ...
      description        = "WebApp Lambda to PG WebApp DB"       # ✅ Optional argument — recommended to keep.
      ipv6_cidr_blocks   = null                                  # ✅ Optional argument — recommended to keep.
      prefix_list_ids    = null                                  # ✅ Optional argument — recommended to keep.
      security_groups    = null                                  # ✅ Optional argument — recommended to keep.
      self               = null                                  # ✅ Optional argument — recommended to keep.
  ...
  ingress_rules          = [
    {
      ...
      to_port            = 5432                                  # 🔒 Required argument.
      protocol           = "tcp"                                 # 🔒 Required argument.
      cidr_blocks        = ["${var.github_runner_ip}"]           # ✅ Optional argument — recommended to keep.
      description        = "GitHub Runner to Postgres WebApp DB" # ✅ Optional argument — recommended to keep.
      ipv6_cidr_blocks   = null                                  # ✅ Optional argument — recommended to keep.
      prefix_list_ids    = null                                  # ✅ Optional argument — recommended to keep.
      security_groups    = null                                  # ✅ Optional argument — recommended to keep.
      self               = null                                  # ✅ Optional argument — recommended to keep.
...
//preferred_maintenance_window        = "sun:01:00-sun:02:00"                                     # ✅ Optional argument — recommended to keep.
  ...
  vpc_security_group_ids              = [                                                         # ✅ Optional argument — 🚨 highly recommended to keep.
    module.webapp_lambda_to_pg_webapp_db_sg.id,
...
module "webapp_db_aws_secretsmanager_secret" {
  ...
  kms_key_id                     = null                        # ✅ Optional argument.
  name                           = "webapp-db-credentials-10"  # ✅ Optional argument — 🤜💥🤛 Conflicts with `name_prefix`.
...
module "webapp_aws_ecrpublic_repository" {
  ...
  catalog_data        = {                                        # ✅ Optional argument, but keep it.
    ...
    logo_image_blob   = filebase64("./logo/bala-info-tech.png")  # ✅ Optional argument, but keep it.
...
module "webapp_aws_ecrpublic_repository_policy" {
  ...
  repository_name = module.webapp_aws_ecrpublic_repository.id                                # 🔒 Required argument
